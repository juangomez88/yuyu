...
## Toguro: 
    ...
    Pero si se te ocurre rechazarlo,
    den por hecho que sus vidas llegarán a su fin.

![image](https://github.com/user-attachments/assets/ee51fe65-f4ca-4bc3-986a-6fba204ebcd1)

## Yusuke:
    ¡Quiero hacerme más fuerte!

## Botan:
    ¡Es urgente, es urgente, Yusuke! ¡El Sr. Koenma te está llamando!

![image](https://github.com/user-attachments/assets/b9ecbfdf-ecf5-4b8d-9c67-8327a408b376)

## Botan: 
    De todos modos, vuelve a casa primero. Yo iré a llamar a los demás.

![image](https://github.com/user-attachments/assets/4c045100-424f-4cda-a9ad-4170427e34b0)

## Botan: 
    ¡Oye, Hiei!

![image](https://github.com/user-attachments/assets/ddef7af0-634a-41a4-9770-d8d5e7a3d329)

## Hiei: 
    ¡¿Quién se atreve a interrumpir mi siesta?!

## Botan: 
    El señor Koenma te está llamando.

## Pasa corriendo Kuwacchan 
![image](https://github.com/user-attachments/assets/32dbb975-23b9-4521-9755-0142d5aaa889)
## Botan:
    ¡Oye, Kuwacchan! ¡Es urgente!
![image](https://github.com/user-attachments/assets/19f5fb84-7fe8-4fc2-9b44-9c099bf7d73c)
## Botan:
    ¡El señor Koenma te llama!

![image](https://github.com/user-attachments/assets/6f525d0b-cca8-41c4-bb3f-46c40746b4d2)
### Voz de Botan:
    ¡Kurama!
![image](https://github.com/user-attachments/assets/0e89f38b-ca0e-441e-99cb-9ec74853ee2d)

## Kurama: 
    ¿Es una llamada de Koenma?

![image](https://github.com/user-attachments/assets/27caebd3-a9ce-4025-b569-ad7976e274e1)
## Botan:
    ¡Ding-dong!

### Narrador:
    El apartamento de Yusuke.
    Empieza el noticiero de Koenma.

### Se muestra una foto de todos

![image](https://github.com/user-attachments/assets/a5907bcc-7bdc-4e5a-8346-de733ea712ce)
## Koenma: 
    Mientras ustedes estaban tan concentrados en los combates,
    la energía demoníaca en la ciudad se ha elevado de forma anormal.

![image](https://github.com/user-attachments/assets/4a55ba79-f558-4b52-afe7-a90606fa99c7)
## Yusuke:
    ¿Y entonces?

![image](https://github.com/user-attachments/assets/a5e8d4a9-1116-48b0-8f7a-4e7c4131dff4)
## Koenma: 
    Averigüen la causa y corten el origen de esa energía demoníaca.

![image](https://github.com/user-attachments/assets/d92cb547-12de-4f69-b492-d3d1ee25131c)
## Yusuke:
    ¡No digas tonterías!
    ¿Crees que tengo tiempo para eso?

![image](https://github.com/user-attachments/assets/4a4357db-8113-4dcf-a634-496b3490552b)
## Kuwabara:
    ¡Tenemos que salir en el barco para el torneo dentro de dos días!
    ¡Si llegamos tarde, sería una vergüenza como hombres!

## ![image](https://github.com/user-attachments/assets/d4dd6bbd-e378-400b-9e72-4bfc2fd2ae62)
    ¡¡TONTOS!!
    ¡No hay excusas!
    ¡Salgan de inmediato!

## Se muestra pantalla de seleccion de personaje
![image](https://github.com/user-attachments/assets/6baccd2d-b7b7-44cf-ba69-299018599516)

### Capítulo de Yusuke
![image](https://github.com/user-attachments/assets/858b535c-f3c0-4621-8571-dd7e33eee7f3)

## Yusuke:
    ¿Guau! Si tan solo tuviera el poder de esa bola de hierro..
## Yusuke:
    Voy a derrotar a Toguro ahora mismo...

### ...recuerdo...
![image](https://github.com/user-attachments/assets/a387114a-5e84-47f2-8d43-cc7cef2c87c9)
## Toguro:
    "Escucha, debes participar en el torneo Oscuro, allí es donde resolveremos nuestra disputa.
    Pero si te niegas, da por hecho que tu vida llegará a su fin.

![image](https://github.com/user-attachments/assets/cd52ca23-3f67-41dd-b02f-a7ccea3f22e9)
## Yusuke:
    "Maldita sea, ¿cómo podré vencer a Toguro?

![image](https://github.com/user-attachments/assets/7c54d97d-3cb1-4b4b-b8ee-68b9c23455fc)
## Se muestran las opciones de ver, hablar y moverse

* Ver: Había un aura extraña en el lugar pero a Yusuke no le molestaba.
* Hablar: ![image](https://github.com/user-attachments/assets/473de2e2-d53b-455c-8421-08c82ca1a0f9)
  ## Yusuke:
...
*Moverse:
  *Estación:
  ...
  ## Yusuke:
    A este ritmo Toguro nos destruirá...

![image](https://github.com/user-attachments/assets/8d20cea5-7f87-4bbd-8df6-c1a5fde8dea9)
...
![image](https://github.com/user-attachments/assets/9b284ec1-d14f-4a51-9809-397d92efbc9b)
# Yusuke: 
    ¡¡Idiota!!
![image](https://github.com/user-attachments/assets/8dcbf31d-da84-4ed9-8674-fe7d4dac3fab)
# Yusuke: 
    ¡No deberías estar deambulando pora acá!

## opciones:
* Ver: Había un aura extrala en lugar pero a Yusuke no le molestaba.
  
* Hablar: No hay nadie aquí.
  
* Moverse:
    * Escuela:
      ![image](https://github.com/user-attachments/assets/07bcb666-c0bf-498b-be12-34ae80152045)
      ## Yusuke:
          Es la tia de Kirishima.
      ![image](https://github.com/user-attachments/assets/f94f4422-3b9f-40b4-ba32-b7fef74c2fc3)
      ## Tía:
          "¿Oh ?"
          Urameshi-kun, ¿Qué haces aquí?
      ![image](https://github.com/user-attachments/assets/2cc09991-d7ca-4283-80af-be20dc9abcf3)
      ## Yusuke:
          ¿Cómo está Kirishima?
      ![image](https://github.com/user-attachments/assets/f8d04d4d-3630-49b5-8296-f2c86eb30a6c)
      ## Tía:
          Dijo que iba a ir a la escuela intensiva, pero.....
          ¿hay algo que necesites?
      ![image](https://github.com/user-attachments/assets/b653880a-a307-4005-a293-b32ebf7f3768)
      ## Yusuke:
          "¡¿Jukuu?!
          ¿Qué pasó?"
          "¡Disculpe las molestias!"
      ![image](https://github.com/user-attachments/assets/95f2b430-d830-491f-aa0a-8c5f6fc516ed)
      ## Tía:
          "Son raros, idiotas. Habia lagunos tipos raros en el parque también....."

    * Parque:
      ![image](https://github.com/user-attachments/assets/6c4d0da8-75d8-44c9-8ddc-001437a1fcb0)
      ## Yusuke:
          Oh, los chicos del pueblo al lado:
          Momento perfecto.
      ![image](https://github.com/user-attachments/assets/e8646c4f-fd2e-4e57-94e0-d26b2aae6b73)
      ## Yusuke:
          ¡Bastardos!
          ¡Vamos a pasar un rato juntos!
          Estoy de mal humor ahora mismo, ¡Vamos!
      ![image](https://github.com/user-attachments/assets/56f8d840-c91b-46b4-8382-ae0d8fc5efd2)
      ![image](https://github.com/user-attachments/assets/b463b15b-09d5-4d11-8b41-39b378876424)

      ## Yusuke:
          "Chicos, ¿Han tomado forma de demonios?"
          ¡Maldita se, en este punto seré tu enemigo sin importar quien sea!

      ## Narrador
          ¡De repente se convierte en demonio y ataca!
![image](https://github.com/user-attachments/assets/ed56e2d5-56df-4346-928e-65b94b8148c1)
![image](https://github.com/user-attachments/assets/52077303-31ea-4438-bd98-3bf49bb94879)
## Yusuke:
    Maldita sea, este no es momento para hacer cosas así....
    De todos modos, estan sucediendo cosas muy extrañas

## Aparece el viejo...
![image](https://github.com/user-attachments/assets/c76d5a74-eeb6-487d-9f6e-7f775f731a32)

## Viejo: 
    jajajajaja, parece que tienes un poco de prisa...
    Cuanto más te apresuras, más miedo tienes....
    Buen trabajo, jejejejeje....

  * Escuela:

    ![image](https://github.com/user-attachments/assets/f7f62960-1c0f-4380-902e-c9cf246dae02)

## Yusuke:
    No he estado aquí por un tiempo, pero me pregunto, ¿cómo estará Takenaka?

![image](https://github.com/user-attachments/assets/d6c1b1e5-4fbc-4eab-a900-919376088c22)
## Takenaka: 
    "¡Estoy aquí! ¡Urameshi!"

![image](https://github.com/user-attachments/assets/f6ae068d-5557-4389-b447-4913a7c3475f)
## Yusuke:
    ¡Oh no!
...
## Capitulo Kuwabara:
### Kuwabara salió a la ciudad por orden de Koenma
![image](https://github.com/user-attachments/assets/57b7aeef-8fb0-42bd-80e1-28210a1612bb)

![image](https://github.com/user-attachments/assets/757ad800-11ca-4ff4-a064-cd6f546c92a6)

## Kuwabara: 
    ¡Este no momento para esas tonterías!

### Salen opciones de:
* hablar:
  ## Kuwabara:
      No es broma si llegas tarde a una pelea propuesta.
      De hecho, ¡Tengo una pelea pactada con la secundaria vecina!
      Si llego tarde a una pelea que yo mismo propuse,
      ¡sería una vergüenza no asistir!
  
* moverse:
   * Parque:
     ![image](https://github.com/user-attachments/assets/0589669b-476e-46cc-be81-01721fec034c)
     ## Hombre:
         Hola ...
     ...
     ## Kuwabara:
         ¡Quítate, estorbas!
     ## Hombre:
         Si tienes este tipo de energía, seguro puedes mejorar tu rendimiento académico.
     ...
     ## Hombre:
         Me caes aún mejor.
         Serías perfecto para el Instituto Tozai.
         Incluso tú podrías ingresar.

     ## Kuwabara:
         ¿Incluso yo? ¡No me tomes el pelo! ¡Me estás haciendo enojar!

      ## Hombre:
          Entonces, por las buenas o por las malas,
          vas a entrar a nuestra academia. Jejeje...
![image](https://github.com/user-attachments/assets/9bd95b14-2fee-403e-9709-7f0d66d3d34a)
## Kuwabara:
    ¡Tú...!
    ¡¿Eres un demonio?!

![image](https://github.com/user-attachments/assets/2732b42f-c9f7-4c84-9e7b-293d4e59a856)

## Kuwabara:
    Fuu~, ¿pero por qué un demonio
    estaría haciendo reclutamiento para una escuela?

### Opciones:
### Hablar:
  ## Kuwabara: 
    Parece que ya no hay más demonios por aquí...
### Moverse:
  ### Parque de la cuidad:
  ## Kuwabara: 
        Parece que ya no hay más demonios por aquí...
  ### Parque de la escuela:
   ## Narrador:
     Kuwabara llegó al parque del encuentro.
  ## Kuwabara: 
    Está demasiado silencioso...
    Parece que nadie ha llegado todavía.

  ## Kuwabara:
    ¿Qué diablos? ¿Dónde están los enemigos y los aliados?

  ### ir a la escuela:

  ![image](https://github.com/user-attachments/assets/569ae786-8b50-4a75-8674-0b7e2fc44a95)

  ## Kuwabara:
    ¿Qué diablos estan haciendo esos tipos aquí?
    ¡Estoy seguro que acordamos reunirnos aquí!
    ¿Me equivoqué yo...?
    ¡No puede ser!

  ![image](https://github.com/user-attachments/assets/0b610091-6797-4d04-bbeb-dec4bf164c02)

  ## Profesor Takenaka:
    Kuwabara, ven aquí un momento.

  ## Kuwabara:
     Oh, Me encontré con este tipo desagradable.

![image](https://github.com/user-attachments/assets/5af490be-b613-4279-9b81-f205fbeed6b3)
...
## Kuwabara: 
    "¡Ja, ja, ja! ¿¡Qué demonios haces, Urameshi!?"

## Hiei: 
    "Qué idiota."

## Yusuke: 
    "¡Imbéciles! ¡Ayudenme de una vez!"

### Yusuke intentó salir, pero resbaló y volvió a caer.
...
## Kurama: 
    "Ustedess dos, dejen de jugar y salgan de ahí de una vez."
...
## Kurama: 
    "Eso parece. Aparentemente, aún estamos a mitad del Estanque de Sangre."
